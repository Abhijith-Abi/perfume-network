...
import { WHATSAPP_NUMBER, STORE_NAME } from '@/lib'
...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    // Build a WhatsApp message from the contact form and open the chat.
    const lines = [
      `*New Enquiry — ${STORE_NAME}*`,
      '',
      `*Name:* ${form.name}`,
      `*Email:* ${form.email}`,
    ...
    <>
      <section className="page-hero">
        ...
        <p className="page-hero__subtitle">
          Have a question about an order, need fragrance recommendations, or want
          to collaborate? Reach out and our team will respond within 24 hours.
        </p>
      ...
      <section className="page-content page-content--surface">
        <div className="contact-grid">
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="contact-form__submit contact-form__submit--whatsapp">
          ...
          <div className="contact-info">
            <div className="contact-info__item">
              ...
              <p className="contact-info__value">support@perfumenetwork.in</p>
            </div>
            <div className="contact-info__item">
              <p className="contact-info__label">Phone</p>
              <p className="contact-info__value">+91 98765 43210</p>
              <p className="contact-info__value" style={{ fontSize: '0.78rem', marginTop: '4px' }}>
            ...
            <div className="contact-info__item">
              ...
              <p className="contact-info__value">
                Perfume Network Pvt. Ltd.<br />
                42 Fragrance Lane, Khan Market<br />
            ...
            <div className="contact-info__item">
              ...
              <div className="contact-info__social">
                <a className="contact-info__social-link" aria-label="Instagram">
                ...
                <a className="contact-info__social-link" aria-label="Facebook">
                  <svg viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a className="contact-info__social-link" aria-label="Twitter">
                  <svg viewBox="0 0 24 24">
